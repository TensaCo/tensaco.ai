...
export function Receipts() {
  const R = [
    ...
    <><b>2 pJ vs 0.002 pJ per multiply.</b> Same model, same step: 36.6 mJ (GPU) and 0.037 mJ (PHASER) divided by the 1.83 × 10¹⁰ multiply–accumulates of one step of a 135,000-neuron dense layer. The field renderings are small live simulations in natural units, not device models: an electron wave packet (2-D Schrödinger equation, split-step) crossing a lattice of thermally vibrating ions that it pushes back on (Ehrenfest coupling; the ions are made light so the exchange shows), and a light packet (2-D wave equation) crossing a glass slab of index 1.5.</>,
